(function () {
  ...
  */
  ...
  _relExp = /[+-]=-?[.\d]+/,
    ...
    return (_installScope = _merge$1(scope, _globals)) && gsap$2;
  },
  ...
  */
  ...
  clamp = function clamp(min, max, value) {
    ...
    return value && _isObject$2(value) && "length" in value && (!nonEmpty && !value.length || value.length - 1 in value && _isObject$2(value[0])) && !value.nodeType && value !== _win$4;
  },
  ...
  toArray = function toArray(value, leaveStrings) {
    return _isString$1(value) && !leaveStrings && (_coreInitted$2 || !_wake()) ? _slice.call(_doc$4.querySelectorAll(value), 0) : _isArray$1(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice.call(value, 0) : value ? [value] : [];
  },
  ...
  _tickerActive,
    ...
    _self = {
      ...
      wake: function wake() {
        if (_coreReady) {
          if (!_coreInitted$2 && _windowExists$3()) {
            _win$4 = _coreInitted$2 = window;
            _doc$4 = _win$4.document || {};
            _globals.gsap = gsap$2;
            (_win$4.gsapVersions || (_win$4.gsapVersions = [])).push(gsap$2.version);
    ...
    function Tween(targets, vars, time, skipInherit) {
      ...
      if (keyframes || stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
        ...
        if (keyframes) {
          ...
          staggerFunc = stagger ? distribute(stagger) : _emptyFunc$1;
      ...
      if (immediateRender || !duration && !keyframes && _this3._start === _round$1(parent._time) && _isNotFalse(immediateRender) && _hasNoPausedAncestors(_assertThisInitialized$1(_this3)) && parent.data !== "nested") {
  ...
  */
  ...
  gsapWithCSS.set("#orange-mtn",{transformOrigin:"center"});
